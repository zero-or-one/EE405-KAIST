...
class WaypointFollower():
    ...
    # Controller
    def steer_control(self, error_y, error_yaw, v):
        """
        Steering control
	...
	# P controller
        ...
        ki_y = 0 # 0.05 # uncomment for pi controller
        ki_yaw = 0 # 0.05 # uncomment for pi controller
        kd = 0 # 0.05 # uncomment for pi controller
    ...
    def speed_control(self, error_v):
        ...
        kp_v = 0.7
        # for PI controller
        ki_v = 0 #0.03 # uncomment for pi controller
        kd = 0
        self.error_v_sum += error_v
        v_change = kp_v * error_v + ki_v*error_v_sum + kd*self.error_v_prev
